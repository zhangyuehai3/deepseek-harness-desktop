...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\EZAI Desktop\\EZAI Desktop.exe',
  upstreamRunner: 'C:\\Program Files\\EZAI Desktop\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\EZAI Desktop\\resources\\app.asar\\desktop-runner.js',
}
