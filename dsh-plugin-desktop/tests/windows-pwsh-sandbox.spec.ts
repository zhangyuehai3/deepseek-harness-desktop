...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\EZAIGC Desktop\\EZAIGC Desktop.exe',
  upstreamRunner: 'C:\\Program Files\\EZAIGC Desktop\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\EZAIGC Desktop\\resources\\app.asar\\desktop-runner.js',
}
