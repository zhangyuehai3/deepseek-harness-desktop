 ...
 */
function mergeCookieStrings(...sources) {
    const map = new Map();
...
export function createEzaiClient(options, session) {
    ...
    return {
        ...
        async login(username, password, captcha, captchaCookies) {
        ...
        async fetchPersonalInfo(cookies) {
...
function parsePersonalDetailsHtml(html, cookies) {
    try {
        const info = {};
