...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Open EZAI Terminal to update or remove the failing third-party plugin, then restart EZAI Desktop.',
    openTerminal: 'Open EZAI Terminal',
    restart: 'Restart EZAI Desktop',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'EZAI Desktop Update Available',
    updateAvailableMessage: version => `EZAI Desktop ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    download: 'Download',
    later: 'Later',
    forceUpdateTitle: 'EZAI Desktop Update Required',
    forceUpdateMessage: version => `EZAI Desktop ${version} is required.`,
    ...
    updateCheckFailedMessage: 'EZAI Desktop could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'EZAI Desktop Is Up to Date',
    upToDateMessage: 'No newer version of EZAI Desktop is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'EZAI Desktop Update Downloaded',
    updateReady: version => `EZAI Desktop ${version} has been downloaded.`,
    ...
    updateInstalled: version => `EZAI Desktop ${version} has been installed.`,
    ...
    terminalErrorTitle: 'Unable to Open EZAI Terminal',
    terminalErrorMessage: 'EZAI Desktop could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'EZAI Desktop could not export the diagnostic archive.',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请打开 EZAI 终端更新或移除失败的第三方插件，然后重启 EZAI Desktop。',
    openTerminal: '打开 EZAI 终端',
    restart: '重启 EZAI Desktop',
    dismiss: '关闭',
    updateAvailableTitle: 'EZAI Desktop 有可用更新',
    updateAvailableMessage: version => `EZAI Desktop ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    download: '下载',
    later: '稍后',
    forceUpdateTitle: 'EZAI Desktop 需要更新',
    forceUpdateMessage: version => `请更新到 EZAI Desktop ${version}。`,
    forceUpdateDetail: '当前版本已停止使用，必须更新后才能继续使用。',
    forceUpdateConfirm: '立即更新',
    forceUpdateQuit: '退出',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'EZAI Desktop 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'EZAI Desktop 已是最新版本',
    upToDateMessage: '当前没有更新版本的 EZAI Desktop。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'EZAI Desktop 更新已下载',
    updateReady: version => `EZAI Desktop ${version} 安装包已下载。`,
    ...
    updateInstalled: version => `EZAI Desktop ${version} 已安装。`,
    removeInstallerQuestion: path => `是否删除下载的安装包以释放磁盘空间？\n\n${path}`,
    deleteInstaller: '删除安装包',
    keepInstaller: '保留安装包',
    terminalErrorTitle: '无法打开 EZAI 终端',
    terminalErrorMessage: 'EZAI Desktop 无法打开终端。',
    diagnosticsErrorTitle: '无法导出诊断信息',
    diagnosticsErrorMessage: 'EZAI Desktop 无法导出诊断包。',
