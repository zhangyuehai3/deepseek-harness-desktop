...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up EZAI Desktop',
    profile: 'Profile',
    welcomeTitle: 'Welcome to EZAI Desktop',
    ...
    communityMarketBody: 'The open market built into EZAI Desktop, including custom data sources.',
    ...
    startUsing: 'Start using EZAI Desktop',
  ...
  zh: {
    ...
    beta: 'Beta',
    title: '设置 EZAI Desktop',
    profile: 'Profile',
    welcomeTitle: '欢迎使用 EZAI Desktop',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'EZAI Desktop 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
