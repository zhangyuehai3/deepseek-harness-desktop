...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Update or uninstall the failed third-party plugins in EZAI Terminal, then restart the app.',
    ...
    installStableAlongsideBeta: 'Install the stable edition alongside EZAI Desktop Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    ...
    updateReady: version => `EZAI Desktop ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace EZAI Desktop in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart EZAI Desktop and run the installer now?',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请在 EZAI 终端中更新或卸载加载失败的第三方插件，然后重启应用。',
    ...
    installStableAlongsideBeta: '是否同时安装稳定版？EZAI Desktop Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    ...
    updateReady: version => `EZAI Desktop ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 EZAI Desktop，然后重新打开。',
    windowsInstallQuestion: '现在重启 EZAI Desktop 并运行安装程序？',
