...
describe('package integration contract', () => {
  it('loads the Client through the official settings, sidebar, and shell features', () => {
    ...
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-file-upload', '0.1.5-rc.2')
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-layout', '0.1.5-rc.2')
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-renderer', '0.1.5-rc.2')
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-session', '0.1.5-rc.2')
    ...
    expect(manifest.peerDependencies).toHaveProperty('@deepseek-ai/dsh-client-ui-workspace', '0.1.5-rc.2')
  })
})
